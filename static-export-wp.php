 ...
 * Plugin URI:        https://github.com/your-username/static-export-wp
 ...
 * Author URI:        https://github.com/your-username/static-export-wp
...
if ( version_compare( PHP_VERSION, '8.1', '<' ) ) {
	add_action( 'admin_notices', function () {
		printf(
			...
			esc_html__( 'Static Export WP requires PHP 8.1 or higher.', 'static-export-wp' )
		);
	} );
	return;
}
